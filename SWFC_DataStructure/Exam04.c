...
/***********************************************************/
// [1-4] 배열 기반 연결 리스트 - 더블 링크
/***********************************************************/

#if 0

/***********************************************************/
// [1-4.1] 기존 Linked List 방식중 그대로 사용하는 함수들
...
int Insert_Node(SCORE *head, SCORE *d)
{
	for (int i = 0; i < MAX_ST; i++) {
		if (head->next == NULL || head->next->id > d->id) {
			d->next = head->next;
			d->prev = head;
			if (head->next) head->next->prev = d;          // 마지막에 자료를 추가할 경우 head->next가 존재하지 않는다. (NULL)
			head->next = d;
...
/***********************************************************/
// [1-4.3] 주어진 사번의 node를 찾아서 삭제하는 함수
/***********************************************************/
...
/***********************************************************/
// [1-4.5] 더블 링크 사용의 장점 2, 역방향으로 일정 범위 인쇄
/***********************************************************/
